...
//---------------------------- KONSTRUKTOR ---------------------------	
	public FindNumber() {							
		...
		titleTextField.setText("Znajdź wylosowaną liczbę z przedziału 1-99");
...
//---------------------------------------------------------------
		...
		messageTextField.setText("Wprowadź liczbę");
...
//		gridConstraints.insets = new Insets(5, 5, 5, 5); 
		...
		clearListButton.setText("Czyść listę wyników");
		gridConstraints = new GridBagConstraints();
		gridConstraints.gridx = 0;
		gridConstraints.gridy = 7;
		gridConstraints.insets = new Insets(10, 10, 10, 10); 		
...
//------------------------------------------------------------------------------
	private void bestActionPerformed(ActionEvent e) {
		JOptionPane.showMessageDialog(this, "Autor: Grzegorz Rapacz", "Znajdź liczbę by GR", JOptionPane.INFORMATION_MESSAGE);
	}
...
//		System.out.println(randomNumber);
	...
	void sprawdzLiczbe() {
		...
		if (inputTextField.getText().equals("")) {		//jak pole puste to return
			messageTextField.setText("Wprowadź liczbę z przedziału 1-99");
        	return;
		}
    	...
    	if (yoursNumber == randomNumber) {				//zgad?
    		...
    		messageTextField.setText("Zgadłes za " + ktoryRaz + " razem.\n Czas: " + sTime + " s");
...
//--------------------------------------------------------
    	...
    	if (yoursNumber < randomNumber) {				//Za malo
    		messageTextField.setText("ZA MAŁO. Spróbuj jeszcze raz");
    	...
    	if (yoursNumber > randomNumber)	{				//Za duzo
    		messageTextField.setText("ZA DUŻO. Spróbuj jeszcze raz");
	...
	private void aboutActionPerformed(ActionEvent e) {
		JOptionPane.showMessageDialog(this, "Znajdź wylosowaną liczbę z przedziału 1-99\nAutor: Grzegorz Rapacz", "Znajdź liczbę by GR", JOptionPane.INFORMATION_MESSAGE);
	}
